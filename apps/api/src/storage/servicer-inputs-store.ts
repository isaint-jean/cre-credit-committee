...
export type ServicerInputFieldType = 'site_visit' | 'broker_feedback' | 'tab_commentary' | 'site_visit_checklist' | 'site_photos' | 'portfolio_structure' | 'sales_comps' | 'lease_comps' | 'site_inspection' | 'deal_mode' | 'deal_mode_source';
