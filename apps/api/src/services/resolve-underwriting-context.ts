...
export function resolveUnderwritingContext(
  ...
  const out: ResolvedUnderwritingContext = {
    ...
    property: {
      ...
      // Sprint-0 additions — propertyMetadata-only sources.
      msa:               ALLOWED_OPS.passthrough<ResolvedCellValue>(ctx.property?.msa               ?? null),
      ...
      noteDate:          ALLOWED_OPS.passthrough<ResolvedCellValue>(ctx.property?.noteDate          ?? null),
    },
    loan: {
    ...
    appraisal: {
      pgr:                            ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.pgr ?? null),
      economicOccupancy:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.economicOccupancy ?? null),
      physicalOccupancy:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.physicalOccupancy ?? null),
      badDebt:                        ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.badDebt ?? null),
      otherIncomeGross:               ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.otherIncomeGross ?? null),
      netEffectiveReimbursements:     ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.netEffectiveReimbursements ?? null),
      expensesGeneralAdmin:           ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesGeneralAdmin ?? null),
      expensesRepairsMaintenance:     ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesRepairsMaintenance ?? null),
      expensesUtilities:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesUtilities ?? null),
      expensesOtherVariable:          ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesOtherVariable ?? null),
      expensesManagement:             ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesManagement ?? null),
      expensesTaxes:                  ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesTaxes ?? null),
      expensesInsurance:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.expensesInsurance ?? null),
      capex:                          ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.capex ?? null),
      asIsValue:                      ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.asIsValue ?? null),
      asStabilizedValue:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.asStabilizedValue ?? null),
      landValue:                      ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.landValue ?? null),
      overallCapRate:                 ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.overallCapRate ?? null),
      terminalCapRate:                ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.terminalCapRate ?? null),
      discountRate:                   ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.discountRate ?? null),
      stabilizedNOI:                  ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.stabilizedNOI ?? null),
      currentNOI:                     ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.currentNOI ?? null),
      stabilizationMonths:            ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).appraisal?.stabilizationMonths ?? null),
    ...
    issuerUw: {
      ...
      badDebt:                        ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.badDebt ?? null),
      uwAdjustments:                  ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.uwAdjustments ?? null),
      otherIncome:                    ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.otherIncome ?? null),
      reimbursements:                 ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.reimbursements ?? null),
      expensesGeneralAdmin:           ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesGeneralAdmin ?? null),
      expensesRepairsMaintenance:     ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesRepairsMaintenance ?? null),
      expensesUtilities:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesUtilities ?? null),
      expensesOtherVariable:          ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesOtherVariable ?? null),
      expensesManagement:             ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesManagement ?? null),
      expensesTaxes:                  ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesTaxes ?? null),
      expensesInsurance:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).issuerUw?.expensesInsurance ?? null),
    ...
    t12: {
      ...
      economicOccupancy:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.economicOccupancy ?? null),
      badDebt:                        ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.badDebt ?? null),
      uwAdjustments:                  ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.uwAdjustments ?? null),
      otherIncome:                    ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.otherIncome ?? null),
      reimbursements:                 ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.reimbursements ?? null),
      expensesGeneralAdmin:           ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesGeneralAdmin ?? null),
      expensesRepairsMaintenance:     ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesRepairsMaintenance ?? null),
      expensesUtilities:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesUtilities ?? null),
      expensesOtherVariable:          ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesOtherVariable ?? null),
      expensesManagement:             ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesManagement ?? null),
      expensesTaxes:                  ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesTaxes ?? null),
      expensesInsurance:              ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.expensesInsurance ?? null),
      capex:                          ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.capex ?? null),
      tenantImprovements:             ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.tenantImprovements ?? null),
      leasingCommissions:             ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.leasingCommissions ?? null),
      totalIncome:                    ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.totalIncome ?? null),
      periodYear:                     ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.periodYear ?? null),
      vintage:                        ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.vintage ?? null),
      creditSignal:                   ALLOWED_OPS.passthrough<ResolvedCellValue>((ctx as any).t12?.creditSignal ?? null),
    },
    parties: {
