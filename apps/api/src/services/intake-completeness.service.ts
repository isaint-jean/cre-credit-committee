...
export const INTAKE_FIELD_BINDINGS: readonly IntakeFieldBinding[] = [
  ...
  { id: 'whole_loan_balance', section: 'Leverage & coverage', field: 'Whole-loan balance (if pari-passu)', feeds: 'Whole-loan debt yield', blocks_if_missing: 'Piece-level DY misleads', criticality: 'Required', tier: 'A', extraction_key: 'none — not extracted today', fallback_keys: ['annexA.pariPassuCombination.combinedCutOffBalance'], source_doc_types: [] },
