...
### 10.14 AdjustedAssumptions render-side projection — #24 ship (`<SHIP-HASH>`, 2026-06-05)
...
- AdjustedAssumptions (rentGrowthPct, expenseGrowthPct, capRate, terminalCapRate) — backend-editable today via POST /:id/revisions but not projected to `RenderedAnalysis`. Tracked at [#24](https://github.com/isaint-jean/cre-credit-committee/issues/24). **Update (v12):** projected to `RenderedAnalysis` as of `<SHIP-HASH>` (see §10.14); [#24] closed. Resolved dependency; bullet preserved as a historical record per the layering discipline.
...
- `<SHIP-HASH>` (2026-06-05) — #24 AdjustedAssumptions render-side projection (first render-side implementation ticket; resolves #24; §10.14 ship details + 8-delta capture; §12.5 closure marker; §12.1 + §12.3 + §9 item 4 v12 layered notes; RENDER_VERSION 7.2 → 7.3).
...
- `<V12-HASH>` (2026-06-05) — v12: §10.14 #24 ship documentation (first render-side §10 entry; 8-delta capture); §12.5 #24 closure marker; §12.1 Phase 2 row light parenthetical edit; §12.3 AdjustedAssumptions bullet v12 layered note; §9 item 4 v12 layered update.
